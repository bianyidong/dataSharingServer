...
public class UserBiz extends BaseBiz<UserMapper, User> {
    ...
    public void updatenoticeCropBaseInfo(User user,String id) {
        String address=user.getAddress();
        String name=user.getName();
        String telPhone=user.getTelPhone();
        String description=user.getDescription();
        String attr1 = user.getAttr1();
        mapper.updatenoticeCropBaseInfo(name,address,telPhone,description,id,attr1);
    }
    @Override
    public void insertSelective(User entity) {
        ...
        workBenchFeign.generateUserIdentityId(userId,entity.getUsername(),entity.getName());
    }
